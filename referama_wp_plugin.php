...
function referama_embed($args){    
  ...
  if ($collection_id != 0){
    $html = <<<EOD
      <div class="referama_anchor" data-rfm-collection-id="$collection_id" data-rfm-visualization="$visualization"></div>
      ...
      <div class="powered_by_referama">
        Powered by <a href="http://www.referama.com" target="_blank">Referama</a> <a href="#" class="rfm_framed_edit" data-rfm-collection-id="11">edit</a>
      </div>
